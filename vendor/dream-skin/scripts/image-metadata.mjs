...
export function classifyImageDimensions({ width, height }) {
  ...
  return {
    ...
    height,
    ratio,
    // 16:10 desktop wallpapers (1.6) are wide enough to carry the complete
    // window background. Reserving immersive mode for 16:9 and wider leaves
    // a 16:10 image trapped inside the main pane and creates a dark seam at
